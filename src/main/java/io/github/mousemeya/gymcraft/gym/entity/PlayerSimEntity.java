...
public class PlayerSimEntity extends PathfinderMob {
    ...
    /**
     * 将真实玩家与 FakePlayer 视为友军，使原版双向 {@code isAlliedTo} 判定、
     * GymCraft 攻击动作和附近实体观测共享同一阵营语义。
     *
     * @param other 待判断关系的另一实体
     * @return 对方为玩家或原版队伍关系为友方时返回 true
     */
    @Override
    protected boolean considersEntityAsAlly(Entity other) {
        return other instanceof Player || super.considersEntityAsAlly(other);
    }
