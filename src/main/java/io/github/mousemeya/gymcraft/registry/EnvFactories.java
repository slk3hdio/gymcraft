...
import io.github.mousemeya.gymcraft.gym.env.envs.*;
...
public final class EnvFactories {
    ...
    public static final DeferredHolder<McEnvFactory, McEnvFactory> GENERAL = REGISTRY.register(
            "general",
            GeneralEnv.Factory::new
    );
